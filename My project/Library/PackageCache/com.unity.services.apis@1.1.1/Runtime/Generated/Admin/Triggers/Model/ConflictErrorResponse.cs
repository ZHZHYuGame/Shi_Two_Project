...
namespace Unity.Services.Apis.Admin.Triggers
{
    ...
    public partial class ConflictErrorResponse
    {
        ...
        [Preserve]
        public ConflictErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
