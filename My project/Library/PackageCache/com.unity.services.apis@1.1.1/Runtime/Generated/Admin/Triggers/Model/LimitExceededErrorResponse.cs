...
namespace Unity.Services.Apis.Admin.Triggers
{
    ...
    /// </summary>
    [DataContract(Name = "LimitExceededErrorResponse")]
    [Preserve]
    public partial class LimitExceededErrorResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LimitExceededErrorResponse" /> class.
        /// </summary>
        ...
        [Preserve]
        public LimitExceededErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for LimitExceededErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
