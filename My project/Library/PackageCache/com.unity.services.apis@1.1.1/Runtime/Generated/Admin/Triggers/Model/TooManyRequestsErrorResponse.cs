...
namespace Unity.Services.Apis.Admin.Triggers
{
    ...
    /// </summary>
    [DataContract(Name = "TooManyRequestsErrorResponse")]
    [Preserve]
    public partial class TooManyRequestsErrorResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TooManyRequestsErrorResponse" /> class.
        /// </summary>
        ...
        [Preserve]
        public TooManyRequestsErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for TooManyRequestsErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
