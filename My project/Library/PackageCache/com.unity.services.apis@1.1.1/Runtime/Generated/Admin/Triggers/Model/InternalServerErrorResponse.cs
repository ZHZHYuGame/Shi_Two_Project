...
namespace Unity.Services.Apis.Admin.Triggers
{
    ...
    public partial class InternalServerErrorResponse
    {
        ...
        [Preserve]
        public InternalServerErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for InternalServerErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
