...
namespace Unity.Services.Apis.Admin.Triggers
{
    ...
    /// </summary>
    [DataContract(Name = "BadRequestErrorResponse")]
    [Preserve]
    public partial class BadRequestErrorResponse
    {
        ...
        [Preserve]
        public BadRequestErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BadRequestErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
