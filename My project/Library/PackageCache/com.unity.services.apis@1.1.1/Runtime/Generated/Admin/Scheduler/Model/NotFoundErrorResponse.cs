...
namespace Unity.Services.Apis.Admin.Scheduler
{
    ...
    /// </summary>
    [DataContract(Name = "NotFoundErrorResponse")]
    [Preserve]
    public partial class NotFoundErrorResponse
    {
        ...
        [Preserve]
        public NotFoundErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for NotFoundErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
