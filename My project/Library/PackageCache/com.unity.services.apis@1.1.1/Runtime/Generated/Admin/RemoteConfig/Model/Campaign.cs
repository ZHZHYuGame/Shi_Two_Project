...
namespace Unity.Services.Apis.Admin.RemoteConfig
{
    ...
    public partial class Campaign
    {
        ...
        /// </summary>
        /// <value>Integer between 0 (highest priority) and 1000 (lowest priority). In the event of a conflict, priority is awarded to the game override that was created first.</value>
        ...
        /// <param name="priority">Integer between 0 (highest priority) and 1000 (lowest priority). In the event of a conflict, priority is awarded to the game override that was created first. (default to 1000).</param>
        ...
        [Preserve]
        public Campaign(string name = default(string), List<CampaignVariants> variants = default(List<CampaignVariants>), bool enabled = false, List<string> kpi = default(List<string>), List<string> audience = default(List<string>), int rolloutPercentage = 100, int priority = 1000, DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), string description = default(string))
        {
            this.Name = name;
