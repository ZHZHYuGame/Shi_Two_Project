...
namespace Unity.Services.Apis.Admin.Environment
{
    ...
    public partial class BasicErrorResponse
    {
        ...
        [Preserve]
        public BasicErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string), List<Object> details = default(List<Object>))
        {
            if (type == null)
            {
