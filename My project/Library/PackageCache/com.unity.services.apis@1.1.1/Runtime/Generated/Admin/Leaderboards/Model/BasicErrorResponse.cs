...
namespace Unity.Services.Apis.Admin.Leaderboards
{
    ...
    public partial class BasicErrorResponse
    {
        ...
        public BasicErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            ...
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for BasicErrorResponse and cannot be null");
            }
            this.Title = title;
            this.Status = status;
            this.Code = code;
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for BasicErrorResponse and cannot be null");
            }
            this.Detail = detail;
