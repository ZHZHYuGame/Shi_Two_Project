...
namespace Unity.Services.Apis.Admin.AccessPolicy
{
    ...
    [Preserve]
    public partial class ServiceUnavailableError
    {
        /// <summary>
        /// Gets or Sets Title
        /// </summary>
        ...
        [Preserve]
        public ServiceUnavailableError(string title = default(string), int status = default(int), string requestId = default(string))
        {
            this.Title = title;
            this.Status = status;
