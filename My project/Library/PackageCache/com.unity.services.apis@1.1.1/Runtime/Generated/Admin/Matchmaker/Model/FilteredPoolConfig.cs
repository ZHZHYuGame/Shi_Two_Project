...
namespace Unity.Services.Apis.Admin.Matchmaker
{
    ...
    [Preserve]
    public partial class FilteredPoolConfig
    {
        /// <summary>
        ...
        [Preserve]
        public FilteredPoolConfig(string name = default(string), bool enabled = true, MatchHosting matchHosting = default(MatchHosting), int timeoutSeconds = default(int), MatchRules matchLogic = default(MatchRules), List<PoolConfig> variants = default(List<PoolConfig>), List<Filter> filters = default(List<Filter>))
        {
            if (name == null)
            {
