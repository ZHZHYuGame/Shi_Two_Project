...
namespace Unity.Services.Apis.Admin.Matchmaker
{
    ...
    [Preserve]
    public partial class BasePoolConfig
    {
        /// <summary>
        ...
        [Preserve]
        public BasePoolConfig(string name = default(string), bool enabled = true, MatchHosting matchHosting = default(MatchHosting), int timeoutSeconds = default(int), MatchRules matchLogic = default(MatchRules), List<PoolConfig> variants = default(List<PoolConfig>))
        {
            if (name == null)
            {
