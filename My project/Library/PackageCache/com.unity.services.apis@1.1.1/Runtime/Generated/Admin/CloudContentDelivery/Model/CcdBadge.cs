...
namespace Unity.Services.Apis.Admin.CloudContentDelivery
{
    ...
    public partial class CcdBadge
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CcdBadge" /> class.
        /// </summary>
        ...
        [Preserve]
        public CcdBadge(DateTime created = default(DateTime), string createdBy = default(string), string createdByName = default(string), string name = default(string), string releaseid = default(string), long releasenum = default(long))
        {
