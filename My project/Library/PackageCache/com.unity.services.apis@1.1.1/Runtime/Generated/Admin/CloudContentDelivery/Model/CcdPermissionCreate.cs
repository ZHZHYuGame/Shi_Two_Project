...
namespace Unity.Services.Apis.Admin.CloudContentDelivery
{
    ...
    [Preserve]
    public partial class CcdPermissionCreate
    {
        /// <summary>
        /// Defines Action
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CcdPermissionCreate" /> class.
        /// </summary>
        /// <param name="action">action (required).</param>
        /// <param name="permission">permission (required).</param>
        /// <param name="role">role (default to RoleEnum.User).</param>
        [Preserve]
        public CcdPermissionCreate(ActionEnum action = default(ActionEnum), PermissionEnum permission = default(PermissionEnum), RoleEnum? role = RoleEnum.User)
        {
            this.Action = action;
