...
namespace Unity.Services.Apis.UGC
{
    ...
    [Preserve]
    public partial class ReportContentRequest
    {
        /// <summary>
        /// Gets or Sets Reason
        /// </summary>
        ...
        /// </summary>
        /// <value>If Reason was Other, provide an alternate reason here</value>
        [DataMember(Name = "otherReason", EmitDefaultValue = true)]
        [Preserve]
        public string OtherReason { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="ReportContentRequest" /> class.
        /// </summary>
        /// <param name="reason">reason (required).</param>
        /// <param name="otherReason">If Reason was Other, provide an alternate reason here.</param>
        [Preserve]
        public ReportContentRequest(Reason reason = default(Reason), string otherReason = default(string))
        {
            this.Reason = reason;
