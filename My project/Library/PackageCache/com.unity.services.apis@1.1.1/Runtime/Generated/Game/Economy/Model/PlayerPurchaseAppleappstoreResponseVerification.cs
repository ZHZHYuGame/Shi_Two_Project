...
namespace Unity.Services.Apis.Economy
{
    ...
    [Preserve]
    public partial class PlayerPurchaseAppleappstoreResponseVerification
    {
        /// <summary>
        ...
        [Preserve]
        public PlayerPurchaseAppleappstoreResponseVerificationStore Store { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerPurchaseAppleappstoreResponseVerification" /> class.
        /// </summary>
        ...
        [Preserve]
        public PlayerPurchaseAppleappstoreResponseVerification(StatusEnum status = default(StatusEnum), PlayerPurchaseAppleappstoreResponseVerificationStore store = default(PlayerPurchaseAppleappstoreResponseVerificationStore))
        {
            this.Status = status;
            if (store == null)
            {
                throw new ArgumentNullException("store is a required property for PlayerPurchaseAppleappstoreResponseVerification and cannot be null");
            }
            this.Store = store;
        }
    }
