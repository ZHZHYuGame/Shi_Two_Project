...
namespace Unity.Services.Apis.CloudContentDelivery
{
    ...
    /// </summary>
    [DataContract(Name = "GetReleases_200_response_inner")]
    [Preserve]
    public partial class GetReleases200ResponseInner
    {
        /// <summary>
        /// Gets or Sets Badges
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReleases200ResponseInner" /> class.
        /// </summary>
        ...
        [Preserve]
        public GetReleases200ResponseInner(List<Badge> badges = default(List<Badge>), Changecount changes = default(Changecount), string contentHash = default(string), long contentSize = default(long), DateTime created = default(DateTime), string createdBy = default(string), string createdByName = default(string), string entriesLink = default(string), Object metadata = default(Object), string notes = default(string), string promotedFromBucket = default(string), string promotedFromRelease = default(string), string releaseid = default(string), long releasenum = default(long))
        {
            this.Badges = badges;
