...
namespace Unity.Services.Apis.CloudContentDelivery
{
    ...
    public partial class Changecount
    {
        ...
        [Preserve]
        public Changecount(long add = default(long), long delete = default(long), DateTime lastModified = default(DateTime), string lastModifiedBy = default(string), string lastModifiedByName = default(string), bool loading = default(bool), long unchanged = default(long), long update = default(long))
        {
            this.Add = add;
            this.Delete = delete;
