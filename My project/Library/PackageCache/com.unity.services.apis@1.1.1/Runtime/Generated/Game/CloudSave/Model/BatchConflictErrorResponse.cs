...
namespace Unity.Services.Apis.CloudSave
{
    ...
    [Preserve]
    public partial class BatchConflictErrorResponse
    {
        /// <summary>
        ...
        [Preserve]
        public BatchConflictErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string), List<ConflictErrorResponseData> data = default(List<ConflictErrorResponseData>))
        {
            if (type == null)
            {
