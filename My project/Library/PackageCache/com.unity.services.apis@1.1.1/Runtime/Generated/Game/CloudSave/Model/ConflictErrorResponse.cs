...
namespace Unity.Services.Apis.CloudSave
{
    ...
    [Preserve]
    public partial class ConflictErrorResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConflictErrorResponse" /> class.
        /// </summary>
        ...
        [Preserve]
        public ConflictErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string), ConflictErrorResponseData data = default(ConflictErrorResponseData))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ConflictErrorResponse and cannot be null");
            }
            this.Type = type;
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for ConflictErrorResponse and cannot be null");
            }
            this.Title = title;
            this.Status = status;
            this.Code = code;
            if (detail == null)
            {
                throw new ArgumentNullException("detail is a required property for ConflictErrorResponse and cannot be null");
            }
            this.Detail = detail;
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ConflictErrorResponse and cannot be null");
            }
            this.Data = data;
