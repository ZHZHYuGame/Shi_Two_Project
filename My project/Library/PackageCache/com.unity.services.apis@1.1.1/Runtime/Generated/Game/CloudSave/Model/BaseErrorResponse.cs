...
namespace Unity.Services.Apis.CloudSave
{
    ...
    /// BaseErrorResponse
    /// </summary>
    [DataContract(Name = "BaseErrorResponse")]
    [Preserve]
    public partial class BaseErrorResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseErrorResponse" /> class.
        /// </summary>
        ...
        [Preserve]
        public BaseErrorResponse(string type = default(string), string title = default(string), int status = default(int), int code = default(int), string detail = default(string), string instance = default(string))
        {
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BaseErrorResponse and cannot be null");
            }
            this.Type = type;
            this.Title = title;
            this.Status = status;
